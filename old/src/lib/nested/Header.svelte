...
<nav class=" border-b border-primary-20 bg-primary">
	<div class="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between p-4">
		...
		<div class="relative flex items-center md:order-2">
			{#if session}
				<div class="flex justify-center">
					<button
						type="button"
						class="mr-3 flex rounded-full bg-primary-20 p-2 text-sm focus:ring-4 focus:ring-gray-300 md:mr-0"
						id="user-menu-button"
						aria-expanded="false"
					...
					<!-- Dropdown Menu-->
					<div
						class="absolute z-10 my-4 mt-12 block w-44 list-none divide-y divide-gray-100 rounded-lg bg-white text-base shadow {showDropDown
							? ''
							: 'hidden'}"
		...
		>
			<ul
				class="mt-4 flex flex-col gap-1 rounded-lg border border-gray-100 bg-gray-50 p-4 font-medium dark:border-gray-700 dark:bg-gray-800 md:mt-0 md:flex-row md:justify-between md:space-x-8 md:border-0 md:bg-primary md:p-0 md:dark:bg-gray-900"
			>
				<li>
					<a
						href="/services"
